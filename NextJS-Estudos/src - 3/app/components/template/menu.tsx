    ...
    return (
                ...
                <aside className="bg-zinc-800 w-80 p-8">
                    <nav className="flex flex-col gap-3">
                        ...
                        <MenuItem texto="Produtos" href="/produtos" icone={<IconList/>}/>
                        <MenuItem texto="Cliente Servidor" href="/cliente-servidor" icone={<IconArrowsDiff/>}/>
                        <MenuItem texto="Administração" href="/admin" icone={<IconUserCircle/>}/>
                    </nav>
                </aside>
